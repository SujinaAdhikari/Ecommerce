...
class ProductView(View):
 def get(self,request):
         ...
         return render(request, 'app/home.html',{'male':male, 'female':female, 'earingsandnecklace':earingsandnecklace, 'shoes':shoes, 'totalitem':totalitem})
...
class KhaltiVerifyView(View):
    def get(self,request,*args, **kwargs):
        ...
        headers = {
               "Authorization": "Key test_secret_key_2ffa43bb0bef413a9f71a31711facadb"
        }
